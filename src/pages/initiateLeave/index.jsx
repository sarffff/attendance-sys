...
const InitiateLeave = () => {
    ...
    const calculateLeaveDays = (start, end) => {
        const diff = (end.valueOf() - start.valueOf()) / (1000 * 60 * 60 * 24);
    ...
    const handleSubmit = async () => {
        ...
        const data = {
            ...
            ...values,
            leaveDays: calculateLeaveDays(values.startTime, values.endTime),
    ...
    const printLeave = async (record) => {
        try {
            ...
            link.download = `请假单_${record.name || record.id || ""}_${new Date().toISOString().slice(0, 10)}.pdf`;
